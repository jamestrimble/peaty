...
all: simple-graph-colourer/graph_colour simple-graph-colourer2/graph_colour vc_solver/solve_vc
...
test:
	./test-script
clean:
	rm -f simple-graph-colourer/graph_colour simple-graph-colourer2/graph_colour vc_solver/solve_vc
