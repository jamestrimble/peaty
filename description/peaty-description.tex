...
?? Maybe mention clause enlarging and sorting

\section{Local search}

?? Cite PLS or something similar?

?? Say when we do local search

\section{Exact graph colouring solver}

?? Say why and say when we run it.

?? Cite Pablo?

?? Mention fractional colouring

\section{Discussion}

?? Mention fractional colouring number and the fact that MIP solvers are probably good for dense graphs.
